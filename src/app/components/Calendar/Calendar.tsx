...
function Calendar(props: { handleCreateEvent: () => void, handleEventView: () => void, handleEventViewClose: () => void }) {
  ...
  return (
    <div className='flex lg:h-[calc(100vh-126px)] xl:h-[calc(100vh-126px)] md:h-[calc(100vh-126px)] sm:h-[calc(100vh-76px)] xs:h-[calc(100vh-76px)] xxs:h-[calc(100vh-76px)] flex-col'>
      ...
      <main className={`flex-1 z-10 overflow-y-auto ${eventsDrawer && ' transition duration-75 mr-96'}`}>
