...
export default function DatePicker() {
  return (
    <div className="mt-2 md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
      <div className="md:pr-5">
      <div className="border border-gray p-2" >
        <div className="flex items-center">
          <h2 className="flex-auto ml-7 text-sm font-small text-gray-900">March 2023</h2>
          <button
            type="button"
          ...
          <button
            type="button"
            className="-my-1.5 mr-3  flex flex-none items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
          >
      ...
      <div className='border !border-r border-gray p-2'>
      <div className="mt-12 md:mt-0 md:pl-8">
        <h2 className="text-sm font-small text-gray-900">
          Schedule for <time dateTime="2022-01-21">March 8, 2022</time>
        </h2>
